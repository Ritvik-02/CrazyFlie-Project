...
def simple_log_async(scf, logconfs):
    ...
    for conf in logconfs:
        conf.start()
    print("start")
    time.sleep(15) # how long to collect data for
    for conf in logconfs:
        conf.stop()
    print("stop")
...
if __name__ == '__main__':
    ...
    #my position file
    my_pos_file = open("testing_data/test10/my_pos_file10.txt","a")
    ...
    #my ypr file
    my_ypr_file = open("testing_data/test10/my_ypr_file10.txt","a")
    my_ypr_file.truncate(0)

    #position file
    pos_file = open("testing_data/test10/position10.txt","a")
    pos_file.truncate(0)
